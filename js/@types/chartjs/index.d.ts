...
export class Chart {
    ...
    constructor(
        ...
        options: ChartN.ChartConfiguration,
    );
    config: ChartN.ChartConfiguration;
    data: ChartN.ChartData;
    destroy: () => {};
    update: ({ duration, lazy, easing }?: ChartN.ChartUpdateProps) => {};
    render: ({ duration, lazy, easing }?: ChartN.ChartRenderProps) => {};
    stop: () => Chart;
    resize: () => Chart;
    clear: () => Chart;
    ...
    options: ChartN.ChartOptions;
    chartArea: ChartN.ChartArea;
    static pluginService: PluginServiceStatic;
    static plugins: PluginServiceStatic;

    static defaults: {
        global: ChartN.ChartOptions & ChartN.ChartFontOptions & {
            tooltips: ChartN.ChartTooltipOptions;
        };
        [key: string]: any;
    };
    ...
    static scaleService: {
        updateScaleDefaults: (type: ChartN.ScaleType, updates: ChartN.ChartScales) => void;
    };

    // Tooltip Static Options
    static Tooltip: ChartN.ChartTooltipsStaticConfiguration;
    static readonly instances: {
        [key: string]: Chart;
    };
}

type Plugin = ChartN.PluginServiceGlobalRegistration & ChartN.PluginServiceRegistrationOptions;
interface PluginDescriptor {
    plugin: Plugin;
    options: ChartN.ChartPluginsOptions;
}
...
declare class PluginServiceStatic {
    ...
    count(): number;
    getAll(): Plugin[];
    notify(chart: Chart, hook: keyof ChartN.PluginServiceRegistrationOptions, args: any): boolean;
    descriptors(chart: Chart): PluginDescriptor[];
}

interface Meta {
    type: ChartN.ChartType;
    data: MetaData[];
    dataset?: ChartN.ChartDataSets | undefined;
...
interface MetaData {
    ...
    _start?: any;
    _view: Model;
    _xScale: ChartN.ChartScales;
    _yScale: ChartN.ChartScales;
    hidden?: boolean | undefined;
}
...
interface Model {
    ...
    borderAlign?: ChartN.BorderAlignment | undefined;
    borderColor: string;
